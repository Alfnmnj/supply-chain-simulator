# app.py (Definitive Version with Corrected & Separated BCP)
...
if run_button:
    if primary_supplier.empty: st.error(f"No primary supplier defined for {selected_component}.")
        ...
        # --- ALL VISUALS & BCP NOW IN TABS FOR COMPLETE ANALYSIS ---
        tab_list = ["📊 Strategic Overview", "💰 Financial Analysis", "🌪️ Sensitivity Analysis", "📄 BCP & Memo"]
        tab1, tab2, tab3, tab4 = st.tabs(tab_list)

        with tab1:
            # ... (Risk vs Cost Quadrant code remains the same) ...
        ...
        # --- NEW, SEPARATED & DYNAMICALLY POPULATED BCP SECTION ---
        with tab4:
            ...
            if is_resilient_simulated:
                ...
                st.markdown(f"""
                    ...
                    <ol>
                        ...
                        <li><b>Initiate Supplier Onboarding:</b> Begin the formal qualification process with <b>{alt_supplier_name}</b>.</li>
                    </ol>
